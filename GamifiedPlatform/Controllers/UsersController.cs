...
namespace GamifiedPlatform.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(GamifiedPlatformContext context)
        {
            _context = context;
        }
        ...
        {
            var Users = await _context.Users.FromSqlRaw($"Exec getUserInfo @UserID={UserId}").ToListAsync();
            return View(Users);
        }
        ...
        public async Task<IActionResult> Create([Bind("UserID,Name,Email,Phone,Address")] User user)
        {
        ...
        public async Task<IActionResult> Edit(int Userid,string name,string email,string phone,string address)
        {
            ...
            await _context.Database.ExecuteSqlInterpolatedAsync($"Exec updateUserInfo @UserID={Userid},@name={name},@email={email},@phone={phone},@address={address}");
