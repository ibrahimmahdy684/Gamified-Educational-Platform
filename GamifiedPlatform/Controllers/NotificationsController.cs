...
namespace GamifiedPlatform.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public NotificationsController(GamifiedPlatformContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Timestamp,Message,UrgencyLevel")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Timestamp,Message,UrgencyLevel")] Notification notification)
        {
